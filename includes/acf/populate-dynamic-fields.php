...
// POST TYPE
// --------------------------------------------------
// set fields with name of `astra_dynamic_post_type`
...
add_filter('acf/load_field/name=astra_dynamic_post_type', 'acf_populate_existing_post_types');

// ==================================================
// IMAGE SIZES
// --------------------------------------------------
// set fields with name of `astra_dynamic_image_size`
...
add_filter('acf/load_field/name=astra_dynamic_image_size', 'acf_populate_existing_thumbnail_sizes');

// ==================================================
// AVAILABLE BLOCK DEFAULT SOURCE
// --------------------------------------------------
// set fields with name of `astra_dynamic_element_default_source`
...
add_filter('acf/load_field/name=astra_dynamic_element_default_source', 'acf_populate_available_element_defaults');
